...
Route::add(['GET'], '/counting', [Controller\Employees::class, 'c','square'])->middleware('employees');
...
Route::add(['GET','POST'], '/file', [Controller\Employees::class, 'file'])->middleware('employees');